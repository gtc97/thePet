...
.tab-item.active { color: var(--theme-primary); font-weight: 600; border-bottom: 4rpx solid var(--theme-primary); }
...
.create-btn {
  ...
  background: var(--theme-primary); color: #fff; text-align: center; padding: 24rpx;
  border-radius: 48rpx; font-size: 30rpx; box-shadow: 0 4px 16px rgba(0,0,0,0.15);
}
</style>
